...
//     }]
//     useEffect(() => {
//         // Load the Google Maps API script after the component has mounted
//         const script = document.createElement('script');
//         script.src = `https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_locatorplus_v7_cABDF`;
//         script.async = true;
//         script.defer = true;
//   return (
//     <section className="home-page-header pt-5 pb-5">
